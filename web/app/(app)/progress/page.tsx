...
export default async function ProgressPage(){
  ...
  return <main className="content native-page"><header className="native-page-header"><div><h1>Personal Records</h1><p>Your best completed sets by exercise.</p></div><Link className="native-pill-action" href="/history">Workout history</Link></header><section className="native-section"><div className="native-section-title"><h2>Current records</h2><span>{buildProgressMetrics(sets).length} exercises</span></div><ProgressDashboard records={buildProgressMetrics(sets)}/></section><section className="native-section"><ManualRecords records={manualRecords} exerciseNames={exerciseNames}/></section></main>
}
