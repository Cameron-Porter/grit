import{NextResponse}from'next/server';import{revalidateTag}from'next/cache';import{createClient}from'@/lib/supabase/server';import{computeProgression}from'@/lib/progression/compute';import{unknownWorkoutExerciseNames}from'@/lib/workout/identity';import{clearProgramIfComplete}from'@/lib/workout/program-completion';import{validateWorkoutDayUpdate,validateWorkoutPayload}from'@/lib/workout/payload';import{dashboardCacheTag}from'@/lib/dashboard/cache';import type{ExperienceLevel}from'@grit/types/program';
...
export async function POST(request:Request){
  ...
  revalidateTag(dashboardCacheTag(user.id),{expire:0});
