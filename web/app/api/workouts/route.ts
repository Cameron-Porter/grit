import{NextResponse}from'next/server';import{createClient}from'@/lib/supabase/server';import{computeProgression}from'@/lib/progression/compute';import{validateWorkoutDayUpdate,validateWorkoutPayload}from'@/lib/workout/payload';import type{ExperienceLevel}from'@grit/types/program';
