...
export const cascadeWeight = (sets:LoggedSet[],setIndex:number,weight:number):LoggedSet[] => sets.map((set,position) => position < setIndex ? set : position === setIndex ? { ...set,weight } : set.complete ? set : { ...set,weight });
