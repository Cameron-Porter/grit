    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Barbell Row (Bent Over)', 'Back',      3, 8,  12, 2),
          ex('Barbell Overhead Press','Shoulders', 3, 10, 15, 2),
          ex('EZ-Bar Curl',           'Biceps',    2, 10, 15, 1),
          ex('Tricep Pushdown (Bar)',  'Triceps',   2, 12, 16, 1),
        ],
      },
      {
        label: 'Full Body B',
        exercises: [
          ex('Romanian Deadlift (Barbell)', 'Hamstrings', 3, 10, 15, 2),
          ...
          ex('Skull Crusher (Barbell)', 'Triceps',    2, 10, 15, 1),
        ],
      },
      {
        label: 'Full Body C',
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Dumbbell Lateral Raise',    'Shoulders', 3, 15, 20, 1),
          ex('Bent-Over Rear Delt Fly',   'Shoulders', 3, 15, 20, 1),
          ex('Tricep Pushdown (Bar)',      'Triceps',   3, 12, 16, 1),
          ex('Skull Crusher (Barbell)',   'Triceps',   3, 10, 15, 1),
        ],
      },
      {
        label: 'Pull',
        exercises: [
          ex('Pull-Up (Normal Grip)',     'Back',    4, 6,  10, 2),
          ex('Barbell Row (Bent Over)',   'Back',    3, 6,  10, 2),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Romanian Deadlift (Barbell)', 'Hamstrings', 3, 8,  12, 2),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Barbell Row (Bent Over)',   'Back',      4, 5,  8,  2),
      ...
      },
      {
        ...
        exercises: [
          ex('Incline Dumbbell Press',    'Chest',     3, 10, 15, 2),
          ex('Dumbbell Row (Single-Arm)', 'Back',      3, 8,  12, 2),
          ex('Seated Dumbbell Press',     'Shoulders', 3, 10, 15, 2),
          ex('Seated Cable Row',          'Back',      3, 10, 15, 2),
          ex('Dumbbell Lateral Raise',    'Shoulders', 3, 15, 20, 1),
      ...
      },
      {
        ...
        exercises: [
          ex('Romanian Deadlift (Barbell)', 'Hamstrings', 4, 6,  10, 2),
          ex('Barbell Hip Thrust',        'Glutes',     3, 10, 15, 1),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Barbell Overhead Press',    'Shoulders', 3, 8,  12, 2),
          ex('Dumbbell Lateral Raise',    'Shoulders', 3, 15, 20, 1),
          ex('Pec Deck Fly',              'Chest',     3, 12, 16, 1),
          ex('Skull Crusher (Barbell)',   'Triceps',   3, 10, 15, 1),
        ],
      },
      {
        label: 'Pull',
        exercises: [
          ex('Pull-Up (Normal Grip)',     'Back',    4, 5,  8,  2),
          ex('Barbell Row (Bent Over)',   'Back',    3, 6,  10, 2),
          ex('Lat Pulldown',              'Back',    3, 10, 15, 2),
          ex('Face Pull',                 'Back',    3, 15, 20, 1),
          ex('EZ-Bar Curl',               'Biceps',  3, 10, 15, 1),
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Bent-Over Rear Delt Fly',   'Shoulders', 3, 15, 20, 1),
          ex('Tricep Pushdown (Bar)',     'Triceps',   3, 12, 16, 1),
          ex('Overhead Tricep Extension (Dumbbell)', 'Triceps', 3, 10, 15, 1),
        ],
      },
      {
        ...
        exercises: [
          ex('Lat Pulldown',              'Back',    3, 10, 15, 2),
          ex('Seated Cable Row',          'Back',    3, 10, 15, 2),
          ex('Dumbbell Row (Supported)',  'Back',    3, 10, 15, 2),
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Tricep Pushdown (Bar)',      'Triceps',   3, 10, 15, 2),
        ],
      },
      {
        label: 'Pull A — Power',
        exercises: [
          ...
          ex('Pull-Up (Normal Grip)',      'Back',      3, 6,  10, 2),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Romanian Deadlift (Barbell)', 'Hamstrings', 3, 6,  10, 2),
      ...
      },
      {
        ...
        exercises: [
          ex('Incline Dumbbell Press',           'Chest',     3, 10, 15, 2),
          ex('Pec Deck Fly',                      'Chest',     3, 10, 15, 2),
          ex('Dumbbell Lateral Raise',            'Shoulders', 3, 10, 15, 2),
          ex('Bent-Over Rear Delt Fly',           'Shoulders', 3, 10, 15, 2),
          ex('Overhead Tricep Extension (Cable)', 'Triceps',   3, 10, 15, 2),
        ],
      },
      {
    ...
    days: [
      {
        ...
        exercises: [
          ...
          ex('Romanian Deadlift (Barbell)', 'Hamstrings', 4, 4, 6,  1),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Tricep Pushdown (Bar)',   'Triceps',   3, 6, 10, 2),
        ],
      },
      {
        label: 'Deadlift',
        exercises: [
          ...
          ex('Pull-Up (Normal Grip)', 'Back',    4, 4, 6,  1),
          ex('Seated Cable Row',   'Back',    3, 6, 10, 2),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Barbell Front Squat',    'Quads',     4, 4, 6,  1),
          ex('Barbell Hip Thrust',     'Glutes',    3, 6, 10, 2),
          ex('Skull Crusher (Barbell)', 'Triceps',   3, 6, 10, 2),
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        exercises: [
          ex('Barbell Row (Bent Over)', 'Back',      2, 10, 15, 3),
          ex('Pull-Up (Normal Grip)',  'Back',      2, 10, 15, 3),
          ex('Dumbbell Lateral Raise', 'Shoulders', 2, 10, 15, 3),
          ex('Dumbbell Curl (Both Arms)', 'Biceps',    2, 10, 15, 3),
          ex('Skull Crusher (Barbell)', 'Triceps',   2, 10, 15, 3),
        ],
      },
      {
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Bent-Over Rear Delt Fly', 'Shoulders', 2, 10, 15, 3),
          ex('Dumbbell Row (Supported)', 'Back',      2, 10, 15, 3),
          ex('EZ-Bar Curl',           'Biceps',    2, 10, 15, 3),
          ex('Tricep Pushdown (Bar)', 'Triceps',   2, 10, 15, 3),
        ],
      },
      {
        label: 'Chest, Legs, Abs',
        exercises: [
          ...
          ex('Romanian Deadlift (Dumbbell)', 'Hamstrings', 2, 10, 15, 3),
        ],
      },
      {
        ...
        exercises: [
          ...
          ex('Skull Crusher (Barbell)',         'Triceps',   2, 10, 15, 3),
          ex('Overhead Tricep Extension (Cable)', 'Triceps',   2, 10, 15, 3),
    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Overhead Tricep Extension (Dumbbell)', 'Triceps', 2, 10, 15, 2),
          ex('Dumbbell Curl (Both Arms)',          'Biceps',  2, 10, 15, 2),
        ],
      },
      {
        label: 'Back, Chest, Delts',
        exercises: [
          ex('Pull-Up (Normal Grip)',  'Back',      2, 10, 15, 2),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Tricep Pushdown (Bar)', 'Triceps',    2, 10, 15, 2),
      ...
      },
      {
        ...
        exercises: [
          ...
          ex('Bent-Over Rear Delt Fly', 'Shoulders', 2, 15, 20, 1),
          ex('Seated Cable Row',      'Back',      2, 15, 20, 1),
          ex('Straight-Arm Pulldown', 'Back',      2, 15, 20, 1),
          ex('Pec Deck Fly',          'Chest',     2, 15, 20, 0),
        ],
      },
    ],
  },
